...
$retrieveRecipeWithCommentsStatement = $mysqlClient->prepare('SELECT r.*, c.comment_id, c.comment, c.user_id, u.name FROM recipes r
...
if ($recipeWithComments === []) {
    echo('La recette nexiste pas zebi');
    return;
}
